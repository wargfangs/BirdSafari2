 ...
 * @ORM\Entity(repositoryClass="Birds\BlogBundle\Repository\ArticleRepository")
 */
class Article
{
    /**
     ...
     * @var String
     * 
     * @ORM\OneToMany(targetEntity="Birds\BlogBundle\Entity\Comment", mappedBy="article", cascade={"persist", "remove"})
     */
